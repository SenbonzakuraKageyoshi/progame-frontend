      ...
      <div className='wrapper'>
        ...
        <div className={asideIsOpened ? 'mainContentActive' : 'mainContent'}>
          <div className="container">
            ...
            {currentLocation.id === 1 && <Courses role='student' type='my' currentUserId={data.id} telephone={data.telephone} email={data.email}/>}
            {currentLocation.id === 2 && <Courses role='student' type='all' currentUserId={data.id} telephone={data.telephone} email={data.email}/>}
            {currentLocation.id === 4 && <Users type='student' />}
            {currentLocation.id === 5 && <Users type='admin' currentUserId={data.id}/>}
            {currentLocation.id === 6 && <Courses role='admin' type='all' currentUserId={data.id} telephone={data.telephone} email={data.email}/>}
          </div>
        </div>
      </div>
      </>
